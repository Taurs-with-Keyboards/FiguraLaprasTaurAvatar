...
-- *strengthmultiplier:	normally .5; this controls how strongly the torso moves
function squapi.torso(element, strengthmultiplier, tilt, keeporiginalheadpos)
	strengthmultiplier = strengthmultiplier or 0.5
	tilt = tilt or 0.4
